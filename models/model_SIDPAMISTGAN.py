...
class SIDSTGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_G = torch.optim.Adam([{'params': self.netG1.module.netG.parameters()}, 
                                                 {'params': self.netG2.module.netG.parameters()},
                                                 {'params': self.netG2.module.netM.parameters()}],
                                                lr=opt.lr, betas=(opt.beta1, 0.999), weight_decay=1e-5)
            self.optimizer_D = torch.optim.Adam([{'params': self.netG1.module.netD.parameters()}, 
                                                 {'params': self.netG2.module.netD.parameters()}],
                                                lr=opt.lr, betas=(opt.beta1, 0.999), weight_decay=1e-5)
    ...
    def forward(self):
        ...
        self.fake_shadow_image = self.netG1.module.forward_G(inputnetG1)
    ...
    def forward_D(self):
        ...
        self.pred_fake1, self.pred_real1 = self.netG1.module.forward_D(fake_AB.detach(), real_AB)
    ...
    def optimize_parameters(self):
        ...
        self.set_requires_grad([self.netG1.module.netD, self.netG2.module.netD], True)  # Enable backprop for D1, D2
        self.optimizer_D.zero_grad()
        self.forward_D()
        self.backward1()
        self.optimizer_D.step()
     
        self.set_requires_grad([self.netG1.module.netD, self.netG2.module.netD], False) # Freeze D
