...
from .network_DSD import define_DSD, bce_logit_pred, bce_logit_dst
from .network_SID import define_SID
...
#         self.final = self.final*2-1
    ...
    def backward2(self):
        ...
        self.loss_G2_L1 = criterion(self.fake_free_shadow_image, self.shadowfree_img) * lambda_
