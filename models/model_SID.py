...
class SIDModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        #parser.set_defaults(checkpoints_dir="C:/Users/m1101/Downloads/Shadow_Removal/SID/_Git_SID/checkpoints_SID/")
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_M = torch.optim.Adam(self.netM.parameters(),
                                                lr=opt.lr, betas=(opt.beta1, 0.999), weight_decay=1e-5)
            self.optimizers = [self.optimizer_G, self.optimizer_M]
    ...
    def backward(self):
        ...
        self.loss_reconstruction = criterion(self.final, self.shadowfree_img) * lambda_
        self.loss = self.loss_G_param + self.loss_reconstruction
        self.loss.backward()
