...
def evaluate(dataset, model_name, result_dir):
...
def print_current_losses(log_dir, model, losses, t_comp):
    message = '{\"testing model\": %s,n\"computing time\": %.3f' % (model, t_comp)
...
if __name__=='__main__':
    ...
    for dataset_name, model_name in testing_dict:    
        ...
        print_current_losses(result_dir, model_name, [PNSR_score, SSIM_score], computing_time)
