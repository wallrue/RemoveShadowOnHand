...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--validDataset_split', type=float, default=0.0001, help='ratio for splitting valid dataset from main dataset')
        ...
        parser.add_argument('--niter_decay', type=int, default=40, help='# of iter to linearly decay learning rate to zero; p/s: lr increases at first, then be zero, then reduces')
        parser.add_argument('--epoch_count', type=int, default=7, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
